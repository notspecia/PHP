...
class Playlist
{
    ...
    private static $table = "playlists";
     ...
     * 
     * @return array|null ritorna un array associativo con tutte le playlist o `null` se non esistono.
     */
     ...
     * @return array|null ritorna un array associativo con i dati della playlist o `null` se non trovata.
     */
    public static function readById($id)
    {
        try {
            ...
            $stmt->execute(['id' => $id]); // esecuzione della query con il parametro ID
    ...
    public static function create($data)
    {
        try {
            ...
            // se l'inserimento non è riuscito, ritorna false
            if (!$result) {
                return false;
            }
    ...
    public static function update($id, $newData)
    {
        ...
        // aggiungi ogni campo che non è nullo
        foreach ($newData as $key => $value) {

            if ($value !== null) {
                // crea la parte della query con i parametri
        ...
        try {
            ...
            $params['id'] = $id; // Aggiunge l'ID ai parametri
     ...
     */
    public static function replace($id, $newData)
    {
        try {
            ...
            // se l'aggiornamento non è riuscito, ritorna false
            if (!$result) {
                return false;
            }
    ...
    public static function delete($id)
    {
        try {
            ...
            $result = $stmt->execute(['id' => $id]);  // Esegui la query con il parametro ID
