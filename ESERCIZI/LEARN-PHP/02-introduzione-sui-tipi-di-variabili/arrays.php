...
// modi di creare un array 
$voti = array(28, 25, 26, 27, 18, 19, 30, 28); 
$voti = [28, 25, 26, 27, 18, 100, 30, 28];

$voti[2] = 30; // andiamo a modificare la 3 posizione di $voti
echo $voti[5] . "<br/> <br/>"; // stampiamo la 5 posizione di $voti2
var_dump($voti); // var_dump ci stampa il tipo di variabile e il suo contenuto
...
//? 01. array normale / multidimensionale 
$zaino = ["string", 12, 13.4, true, [1, 2, 3]];

echo $zaino[4][1] . '<br>'; //output: 2


//? 02. array associativo (al posto di usare gli indici ($i), usiamo delle chiavi) CHIAVE + VALORE
$materieVoti = [
    "storia" => 9, 
    "matematica" => 7, 
    "inglese" => 10
...
//? 03. array multidimensionale associativo 
$temperature = [
